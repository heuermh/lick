...
public class ShiftEcco extends Effect
{
    TimeSignature @ ts;
    ...
    pre => _head1 => _shift1 => _lpf1 => _hpf1 => _mix1 => post;
    _hpf1 => _feedback1 => pre;

    pre => _head2 => _shift2 => _lpf2 => _hpf2 => _mix2 => post;
    _hpf2 => _feedback2 => pre;

    pre => _head3 => _shift3 => _lpf3 => _hpf3 => _mix3 => post;
    ...
    fun static ShiftEcco create(TimeSignature ts) {
        ShiftEcco ecco;
        ts @=> ecco.ts;
        ts.tripletEighthProvider() @=> ecco._dur1;
        ts.eighthProvider() @=> ecco._dur2;
        ts.halfProvider() @=> ecco._dur3;
        ts.quarterProvider() @=> ecco._dur4;

        3.0 => ecco._shift1.shift;
        2.0 => ecco._shift2.shift;
        0.5 => ecco._shift3.shift;
