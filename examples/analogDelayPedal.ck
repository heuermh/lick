...
class IncreaseResonance extends Procedure
{
    fun void run()
    {
        Constrain.constrainf(delay.resonance() * 1.1, 0.0, 1.0) => delay.resonance;
        <<<"resonance", delay.resonance()>>>;
    }
}

class DecreaseResonance extends Procedure
{
    fun void run()
    {
        Constrain.constrainf(delay.resonance() * 0.9, 0.0, 1.0) => delay.resonance;
        <<<"resonance", delay.resonance()>>>;
    }
}
...
IncreaseResonance increaseResonance;
DecreaseResonance decreaseResonance;
...
//increaseResonance @=> stomp.button7Down;
//decreaseResonance @=> stomp.button8Down;
