...
// wrapper for Rubber Band Stereo Pitch Shifter LADSPA plugin, http://breakfastquay.com/rubberband/
public class StereoRubberBand extends Ladspa
{
    prefix + "ladspa-rubberband.so" => ladspa.load;
    "rubberband-pitchshifter-stereo" => ladspa.activate;
