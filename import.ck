...
Machine.add(path + "lick/fn/NearestPrime.ck");
...
Machine.add(path + "lick/dist/Bezier.ck");
...
Machine.add(path + "lick/effect/Cascade.ck");
Machine.add(path + "lick/effect/Caves.ck");
Machine.add(path + "lick/effect/Delta.ck");
